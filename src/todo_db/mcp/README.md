...
registers eight tools over shared service operations.
...
| `tools.py` | The eight task tools: `list_items`, `show_item`, `create_item`, `update_item`, `take`, `release`, `finish`, `renew`. |
